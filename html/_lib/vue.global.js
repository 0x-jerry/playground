var Vue = (function (exports) {
  ...
  */
  ...
  const setRef = (rawRef, oldRawRef, parentComponent, parentSuspense, vnode) => {
    if (isArray(rawRef)) {
      rawRef.forEach((r, i) =>
        setRef(r, oldRawRef && (isArray(oldRawRef) ? oldRawRef[i] : oldRawRef), parentComponent, parentSuspense, vnode)
      )
      return
    }
    let value
      ...
      if (child.type === 1 /* ELEMENT */ && child.tagType === 0 /* ELEMENT */) {
        ...
        if (!doNotHoistNode && (staticType = getStaticType(child, resultCache)) > 0) {
          ...
          if (codegenNode.type === 13 /* VNODE_CALL */) {
            ...
            if ((!flag || flag === 512 /* NEED_PATCH */ || flag === 1) /* TEXT */ && !hasNonHoistableProps(child)) {
  ...
  const transformFor = createStructuralDirectiveTransform('for', (node, dir, context) => {
    ...
    return processFor(node, dir, context, (forNode) => {
      ...
      const keyProperty = keyProp
        ...
        : null
      const isStableFragment = forNode.source.type === 4 /* SIMPLE_EXPRESSION */ && forNode.source.isConstant
